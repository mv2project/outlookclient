...
namespace ISS.MV2.OutlookClient {
    ...
    public sealed partial class MV2Client : Microsoft.Office.Tools.Outlook.OutlookAddInBase {
        ...
        public MV2Client(global::Microsoft.Office.Tools.Outlook.Factory factory, global::System.IServiceProvider serviceProvider) : 
    ...
    internal sealed partial class Globals {
        ...
        private static MV2Client _MV2Client;
        ...
        internal static MV2Client MV2Client {
            get {
                return _MV2Client;
            }
            set {
        ...
        internal static ThisFormRegionCollection FormRegions {
            get {
                if ((_ThisFormRegionCollection == null)) {
                    _ThisFormRegionCollection = new ThisFormRegionCollection(Globals.MV2Client.GetFormRegions());
                }
    ...
    internal sealed partial class ThisFormRegionCollection : Microsoft.Office.Tools.Outlook.FormRegionCollectionBase {
        ...
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Explorer explorer] {
            get {
                return ((WindowFormRegionCollection)(Globals.MV2Client.GetFormRegions(explorer, typeof(WindowFormRegionCollection))));
            }
        }
        
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Inspector inspector] {
            get {
                return ((WindowFormRegionCollection)(Globals.MV2Client.GetFormRegions(inspector, typeof(WindowFormRegionCollection))));
            }
        }
    }
